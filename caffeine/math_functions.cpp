...
void caffe_rng_uniform(const int n, const Dtype a, const Dtype b, Dtype* r) {
  ...
  boost::variate_generator<purine::rng_t*, boost::uniform_real<Dtype> >
...
void caffe_rng_gaussian(const int n, const Dtype a,
  ...
  boost::variate_generator<purine::rng_t*, boost::normal_distribution<Dtype> >
      variate_generator(caffe_rng(), random_distribution);
  for (int i = 0; i < n; ++i) {
    r[i] = variate_generator();
  }
...
void caffe_rng_bernoulli(const int n, const Dtype p, int* r) {
  ...
  boost::variate_generator<purine::rng_t*, boost::bernoulli_distribution<Dtype> >
      variate_generator(caffe_rng(), random_distribution);
  for (int i = 0; i < n; ++i) {
    r[i] = variate_generator();
  }
